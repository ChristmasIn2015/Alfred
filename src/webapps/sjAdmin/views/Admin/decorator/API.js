...
function createShop() {
    ...
    return $common._Server.request('POST', '/sjShop/shop/create', params, $common.getHeader())
}
// * 获取我管理的店铺列表
function getShopList() {
    let params = {}
    return $common._Server.request('GET', '/sjShop/shop/list', params, $common.getHeader())
}
// * 店铺删除
...
function getUserInfo() {
    let params = {}
    return $common._Server.request('GET', '/sjShop/user/info', params, $common.getHeader())
}
// * 用户注册/登录
