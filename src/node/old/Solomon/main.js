...
async function go() {
    try {
        ...
        const AlfredIndex = require('path').join(process.cwd(), './src/web/dist/Solomon.html')
        global['Cabin'].exposeHtml('/Solomon', htmlPath, AlfredIndex)

        // * End
        console.log('Solomon is here', SOCKET_NUMBER)
    } catch (error) {
