...
export function createHouse(shopId, name) {
    ...
    return requester.request('POST', '/qt-shop/house/create', params, $common.getHeaders())
}
// * 获取我管理的仓库列表
export function getHouseList(shopId) {
    let params = { shopId }
    return requester.request('POST', '/qt-shop/house/list', params, $common.getHeaders())
}
// * 仓库删除
...
export function createShop(name) {
    ...
    return requester.request('POST', '/qt-shop/shop/create', params, $common.getHeaders())
}
// * 获取我管理的店铺列表
export function getShopList() {
    let params = {}
    return requester.request('GET', '/qt-shop/shop/list', params, $common.getHeaders())
}
// * 店铺删除
export function deleteShop(shopId) {
    let params = { shopId }
    return requester.request('POST', '/qt-shop/shop/delete', params, $common.getHeaders())
}
// ======================================================= 用户
// * 获取用户信息
export function getUserInfo() {
    let params = {}
    return requester.request('GET', '/qt-shop/user/info', params, $common.getHeaders())
}
// * 用户注册/登录
export function shopUserLogin(name, phone, password) {
    let params = { name, phone, password }
    return requester.request('POST', '/qt-shop/user/login', params)
}
